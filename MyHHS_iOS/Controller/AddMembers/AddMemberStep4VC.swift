...
class AddMemberStep4VC: UIViewController, UIScrollViewDelegate, TagListViewDelegate, UIActionSheetDelegate, UIDocumentPickerDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    @IBAction func onSpecialDieataryClick(_ sender: UIButton) {
        ...
        vc.selectedItemCompletion = {dict in
            ...
            for item in self.dicSelectedDietaries {
                print(item)
            }
    ...
    // To fulfill all conditions of all the validations, (Future Use)
    
//    @IBAction func onSubmitClick(_ sender: Any) {
//        let addMemberStep1VC = AddMemberStep1VC()
//        let addMemberStep2VC = AddMemberStep2VC()
//        let addMemberStep3VC = AddMemberStep3VC()
//        let addMemberStep4VC = AddMemberStep4VC()
//
//
//        if addMemberStep4VC.checkStep4Validation() && addMemberStep3VC.checkStep3Validation() && addMemberStep2VC.checkStep2Validation() && addMemberStep1VC.checkStep1Validation() {
//            self.step4()
//        }
//    }
