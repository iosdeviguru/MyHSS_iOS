//
//  MembershipApplicationsVC.swift
//  MyHHS_iOS
//
...
class MembershipApplicationsTVCell: UITableViewCell {
...
class MembershipApplicationsVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        if strStatus == "all" {
           ...
           navigationBarDesign(txt_title: "MembershipApplications".localized, showbtn: "back")
           self.firebaseAnalytics(_eventName: "MembershipApplicationsVC")
       }
        ...
        self.getMembershipApplicationsAPI()
    }
...
//                print("This is run on the main queue, after the previous code in outer block")
    ...
    // MARK: - API Functions
     ...
     func getMembershipApplicationsAPI() {
...
//         parameters["status"] = "strStatus"
         ...
         APIManager.sharedInstance.callPostApi(url: APIUrl.get_membershipApplications, parameters: parameters) { (jsonData, error) in
             if error == nil
             {
