...
class PaidEventsStep1: UIViewController {
    ...
    @IBOutlet weak var NameField: RAGTextField!
    @IBOutlet weak var ContactField: RAGTextField!
    @IBOutlet weak var ShakhaField: RAGTextField!
    @IBOutlet weak var MedicalInfoField: RAGTextField!
    @IBOutlet weak var MedicationField: RAGTextField!
    @IBOutlet weak var Que1Lbl: UILabel!
